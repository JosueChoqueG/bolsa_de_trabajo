...
return [
    ...
    */
    ...
    'attributes' => [
        ...
        'model'               => 'Modelo',
        'license_plate'       => 'Placa',
        'seats_first_class'   => 'Asientos de primera clase',
        'seats_second_class'  => 'Asientos de segunda clase',
        'additional_capacity' => 'Capacidad adicional',
        'operation_start'     => 'Inicio de operaciones',
        'operation_end'       => 'Fin de operaciones',
        'station_id'          => 'Agencia',
        'document'            => 'Documento',
        'fullname'            => 'Nombre',
        'gender'              => 'Sexo',
        ...
        'line_id'             => 'Ruta',
        'trip_id'             => 'Viaje',
        'departure_station'   => 'agencia de partida',
        'company_document'    => 'Ruc',
        'comapny_name'        => 'Nombre',
        'sender_document'     => 'Documento',
        'sender_name'         => 'Nombre',
        'receiver_document'   => 'Documento',
        'receiver_name'       => 'Nombre',
        'total_price'         => 'Precio total',
        'shipment_date'       => 'Fecha de envio',
        'delivery_date'       => 'Fecha de entrega',
        'delivery_description'=> 'Descripcion entrega',
        'passcode'            => 'Clave de entrega',
        ...
        'departure_scheduled_time' =>'Hora de salida programada'
