jQuery(document).ready(function() 
{
    ...
    var urlJobOffer                  = base_url+'/admin/internalJobOffers';
    ...
    $contentTable.on('click' ,'#table_body button.delete',function(e)
    {
        ...
        let type = 'warning'
        let message = 'Esta seguro(a) de eliminar su oferta laboral de la lista ?';
    ...
    $('#btnSendEmails').on('click',function(e)
    {
        ...
        $('#formSendEmail').attr('action',base_url+'/admin/internalJobOffers/'+id+'/sendEmails');
    ...
    $slc_department_code.on('change',function()
    {
        ...
        if(geolocation_id != ""){
            $slc_district_code.html('');
            //$slc_province_code.attr("required", true);
    ...
    $slc_province_code.on('change',function()
    {
        ...
        if(geolocation_id != ""){
           // $slc_district_code.attr("required", true);
    ...
    $('#li_image').on('click','.pagination li a', function(e){
        e.preventDefault();
